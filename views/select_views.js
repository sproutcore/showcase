  ...
  contentView: Showcase.ViewsListView.design({
    content: [
      Showcase.ViewsItemContent.create({
        title: 'Regular',
        example: "SC.SelectView.extend({  layout: { width: 150, height: 24, centerX: 0, centerY: 0 },  itemTitleKey: 'title',  itemValueKey: 'title',  itemIconKey: 'icon',  items: [  { title: 'Bacon' },  { title: 'Sausage' },  { title: 'Ham' },  { separator: true },  { title: 'Orange', icon: sc_static('images/fruit-orange.png') },  { title: 'Apple', icon: sc_static('images/fruit.png') },  { title: 'Grape', icon: sc_static('images/fruit-grape.png') },  { title: 'Lime', icon: sc_static('images/fruit-lime.png') }  ]  })",
      ...
      // Showcase.ViewsItemContent.create({
      //   title: 'Tiny',
      //   example: "SC.SelectView.extend({  controlSize: SC.TINY_CONTROL_SIZE,  layout: { width: 150, height: 24, centerX: 0, centerY: 0 },  itemTitleKey: 'title',  itemValueKey: 'title',  itemIconKey: 'icon',  items: [  { title: 'Bacon' },  { title: 'Ham' },  { title: 'Sausage' },  { separator: true },  { title: 'Apple', icon: sc_static('images/fruit.png') },  { title: 'Orange', icon: sc_static('images/fruit-orange.png') },  { title: 'Grape', icon: sc_static('images/fruit-grape.png') },  { title: 'Lime', icon: sc_static('images/fruit-lime.png') }  ],  value: 'Grape'  })"
      // }),
      // Showcase.ViewsItemContent.create({
      //   title: 'Small',
